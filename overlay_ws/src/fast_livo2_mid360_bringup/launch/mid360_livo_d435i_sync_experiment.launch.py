...
def generate_launch_description() -> LaunchDescription:
    ...
    default_livo_params = os.path.join(
        bringup_share, "config", "fast_livo2_mid360_livo_d435i_sync_experiment.yaml"
    )
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description="Experiment FAST-LIVO2 synced runtime parameter file",
        ),
        DeclareLaunchArgument(
            "camera_params_file",
        ...
        DeclareLaunchArgument(
            ...
            description="Frame ID for Livox outputs",
        ),
        DeclareLaunchArgument(
            "infra_profile",
        ...
        DeclareLaunchArgument(
            "base_link_pitch_rad",
            default_value="-0.519",
            description="Static aft_mapped->base_link pitch compensation in radians",
        ),
        DeclareLaunchArgument(
            "img_time_offset",
            default_value="0.0",
